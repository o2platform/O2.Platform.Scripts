...
namespace O2.XRules.Database.Languages_and_Frameworks.AspNet
{
	...
	{		
		public ascx_WSDL_Creation_and_Execution launchGui()
		{			
			var wsdlCreation = "ascx_WSDL_Creation_and_Execution".showAsForm<ascx_WSDL_Creation_and_Execution>(1000,700 );											
			O2Thread.mtaThread(
				()=>{						
						wsdlCreation.createMainMenu();
						wsdlCreation.TestWebServices.selectFirst();
					});
			return wsdlCreation;
		}
	}
	...
	{	
		...
		{			
			TestWebServices.add_Item("http://www.webservicex.net/globalweather.asmx?WSDL")
						   .add_Item("http://owasp.teammentor.net/Aspx_Pages/TM_WebServices.asmx?wsdl")						   
		...
		public ascx_WSDL_Creation_and_Execution createMainMenu()
		{
			this.mainMenu()
				.add_Menu("Script")
					.add_MenuItem("Script this Form", ()=> this.script_Me("wsdlGui"));
			return this;
		}
